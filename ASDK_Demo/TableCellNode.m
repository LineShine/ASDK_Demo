...
- (instancetype)initWithData:(id)dataModel {
    if (self = [super init]) {
        ...
        bgViewNode.frame = CGRectMake(0, 0, 375, 200);
        ...
        imgViewNode.frame = CGRectMake(10, 10, 355, 180);
        ...
        labelNode.attributedText = [[NSAttributedString alloc] initWithString:model.text attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:18], NSForegroundColorAttributeName:[UIColor blackColor], NSBackgroundColorAttributeName : [UIColor whiteColor]}];
